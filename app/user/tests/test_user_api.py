...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_blank_password(self):
        """Test returns a blank password returns an error."""
        payload = {
            'email': 'test@example.com',
            'password' : ''
        }
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        self.user.refresh_from_db() # we call this so the user values are refreshed from the database. Since they get patched
